...
namespace DialogueSystem.Elements
{
    public abstract class DGNode : Node
    {
        ...
        public DGNode(Vector2 position, int guid = -1)
        {
        ...
        public void DisconnectAllPorts(DSGraphView graphView)
        {
            DisconnectPorts(graphView, inputContainer);
            DisconnectPorts(graphView, outputContainer);
        }

        private void DisconnectPorts(DSGraphView graphView, VisualElement container)
        {
